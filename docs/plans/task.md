| Task | Status | Details |
|---|---|---|
| RhythmEngine Custom Mode | Completed | Add Custom algorithm mode and customPatternMask to RhythmEngine |
| PluginProcessor APVTS & toggleLaneStep | Completed | Add custom_mask param and toggleLaneStep logic in PluginProcessor |
