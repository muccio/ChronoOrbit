| Task | Status | Details |
|---|---|---|
| CMake MIDI In Support | Completed | Enable NEEDS_MIDI_INPUT in CMakeLists.txt |
| RhythmEngine Rotation Fix & TimeWarp | Completed | Apply rotatePattern to all modes, add timeWarp formula, remove ScaleQuantizer |
